...
export class MensClothingPage extends Component {
    state = {
        products: [],
        loading: false
    }
    ...
    async getProducts() {
        try {
            ...
            const params = {}
            const allProducts = await axios(`https://fakestoreapi.com/products/category/men's clothing`, { params })
    ...
    render() {
        ...
        return (
            <div className='max-w-7xl mx-auto px-5'>
                <h1 className='text-3xl mt-4'>Men&apos;s Clothing Products ({products.length})</h1>
